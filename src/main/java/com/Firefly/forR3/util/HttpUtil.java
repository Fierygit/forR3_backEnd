package com.Firefly.forR3.util;
...
public class HttpUtil {
    ...
    public static String SendGet(String uid, String info) {
        String result = "";
        BufferedReader in = null;
        try {
            String urlNameString = "http://statistics.pandadastudio.com/player/giftCode?uid=";
            urlNameString += uid;
            urlNameString += "&code=";
            urlNameString += info;
